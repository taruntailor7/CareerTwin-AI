(function aiArchitecturePage() {
  ...
  const savedTheme = localStorage.getItem("careerTwinAiArchitectureTheme");
  if (savedTheme) {
  ...
  themeToggle.addEventListener("click", () => {
    ...
    localStorage.setItem("careerTwinAiArchitectureTheme", nextTheme);
  });
